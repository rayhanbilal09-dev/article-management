...
<div class="max-w-3xl mx-auto space-y-6 animate-fade-in duration-300">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Tulis Artikel Baru</h1>
            <p class="text-slate-500 mt-1 text-sm">Bagikan ide, berita, atau panduan menarik Anda ke publik.</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-3xl border border-slate-200/80 shadow-sm overflow-hidden">
        <form action="{{ route('articles.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
            @csrf
