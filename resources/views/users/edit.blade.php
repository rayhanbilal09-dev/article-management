...
<div class="max-w-2xl mx-auto space-y-6 animate-fade-in duration-300">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">Edit Profil User</h1>
            <p class="text-slate-500 mt-1 text-sm">Sesuaikan informasi profil atau ubah kata sandi pengguna ini.</p>
        </div>
    </div>
        ...
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="p-6 md:p-8 space-y-6">
            ...
            <div class="space-y-2">
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-xs font-medium text-slate-400 bg-slate-100 px-2 py-0.5 rounded-md">Opsional</span>
                </div>
                <input 
                    type="password" 
                    id="password"
